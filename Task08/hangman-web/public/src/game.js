/**
 * Игровая логика "Виселицы" без привязки к DOM и IndexedDB.
 * Список слов хранится внутри модуля, как и в консольной версии.
 */
...
export class HangmanGame {
  ...
  /**
   * Начать новую игру с новым случайным словом.
   */
  ...
  /**
   * Подготовить игру к "повтору" сохранённой партии.
   * Используется для воспроизведения игры по данным из IndexedDB.
   */
  loadFromSavedGame(playerName, secretWord) {
    this.playerName = playerName || 'Player';
